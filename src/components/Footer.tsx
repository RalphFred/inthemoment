    ...
    <footer className="bg-[#1a1023] text-white">
      <div className="wrapper pt-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-300">
              Empowering individuals and businesses with expert financial
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a
                  href="mailto:info@inthemoment.com"
                  className="text-gray-300 hover:text-gold transition-colors"
                >
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center text-gray-400">
          <p>
            &copy; {new Date().getFullYear()} In The Moment Financial Services.
            All rights reserved.
          </p>
        </div>
      </div>
      <div className="text-center text-gray-400 py-4">
        built by{" "}
        <Link
          href="https://www.raphaels.studio/"
          target="_blank"
          rel="noopener noreferrer"
